    ...
    <>
      ...
      <div className='px-8 pt-5 flex flex-col justify-between flex-1'>
        <div>
          ...
          <p className='mt-2 text-gray-700'>Dueño: {petI.customer?.name}
            {
              petI.customer?.identity_document?.abbreviation
              &&
              <>
                <br /> {petI.customer?.identity_document?.abbreviation}: {petI.customer?.document_number}
              </>
            }
          </p>
